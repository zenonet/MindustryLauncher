...
public static class MindustryDownloader
{
    ...
    public static async void DownloadIcon(string path, Version version)
    {
        string iconPath = $@"https://raw.githubusercontent.com/Anuken/Mindustry/v{version}/core/assets/icons/icon_64.png";
        
        HttpClient client = new();
        HttpResponseMessage response = await client.GetAsync(iconPath);
